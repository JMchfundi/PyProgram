...
def print_string(message_to_print):
...
class PyProgram:
    ...
    def view_menu(self):
        while True:
            option = input("Menu\n" +
                           "Choose 1, 2 for the following options:\n"
                           "1. Order Pizza\n" +
                           "2. Exit\n")
            if option == '1':
                for pizza in self.pizza_list:
    ...
    def making_pizzas(self):
        ...
        if make_pizza == "1":
            print_string("Preparing the pasta...")
            print_string("Putting on the ingredients...")
            print_string("Pizza is in the oven...")
            print_string("3")
            print_string("2")
            print_string("1")
            print_string("Pizza is ready. Enjoy!\n")
        elif make_pizza == "2":
            self.view_menu()
        else:
            self.making_pizzas()
...
if __name__ == '__main__':
    ps = PyProgram("Awesome PyProgram, ", "Corso di Porta Romana 83," +
